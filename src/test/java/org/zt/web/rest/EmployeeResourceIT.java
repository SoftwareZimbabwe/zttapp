...
import org.zt.repository.EmployeeRepository;
import org.zt.service.dto.EmployeeDTO;
import org.zt.service.mapper.EmployeeMapper;
...
class EmployeeResourceIT {
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee().name(DEFAULT_NAME).dob(DEFAULT_DOB).nationality(DEFAULT_NATIONALITY);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee().name(UPDATED_NAME).dob(UPDATED_DOB).nationality(UPDATED_NATIONALITY);
        return employee;
    }
    ...
    void putExistingEmployee() throws Exception {
        ...
        updatedEmployee.name(UPDATED_NAME).dob(UPDATED_DOB).nationality(UPDATED_NATIONALITY);
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.dob(UPDATED_DOB).nationality(UPDATED_NATIONALITY);
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.name(UPDATED_NAME).dob(UPDATED_DOB).nationality(UPDATED_NATIONALITY);
